  ...
  return (
    <div className="min-h-screen bg-[#080c14] flex items-center justify-center p-6">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-3xl font-bold gradient-text mb-3">Yarn‑to‑Fabric Tracker</h1>
        <p className="text-slate-400 mb-8">
          This module will provide real-time tracking of the full production pipeline —
          from yarn lot intake through knitting programs, grey fabric lots, and dyeing.
          <br /><br />
          <span className="text-slate-500 text-sm font-mono bg-slate-800/60 px-2 py-1 rounded">API: localhost:3002/api</span>
        </p>
        <Link
          href="/"
